...
3. **Graceful degradation**: Non-critical agents (simplifier, convergence-reporter) failing health → skip them silently. Critical agents (feature-code, test-writer) failing → abort iteration.
